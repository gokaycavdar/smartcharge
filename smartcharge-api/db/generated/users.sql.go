...
SELECT r.id, r.date, r.hour, r.is_green, r.earned_coins, r.status,
       r.confirmed_at, r.started_at, r.completed_at, r.checked_in_at, r.check_in_method, r.no_show_at,
...
const markUserPendingReservationsNoShow = `-- name: MarkUserPendingReservationsNoShow :exec
UPDATE reservations
...
func (q *Queries) MarkUserPendingReservationsNoShow(ctx context.Context, userID int32) error {
	_, err := q.db.Exec(ctx, markUserPendingReservationsNoShow, userID)
	return err
}
