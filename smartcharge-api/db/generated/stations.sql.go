...
SELECT id, name, lat, lng, address, price, density, owner_id, density_profile, capacity, qr_secret FROM stations WHERE id = $1
`
...
WHERE id = $1
RETURNING id, name, lat, lng, address, price, density, owner_id, density_profile, capacity, qr_secret
`
